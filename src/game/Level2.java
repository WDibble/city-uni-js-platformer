 ...
 *  @version 1.13.2
 *  @since 1.7
 * This class is Level2.
 * This class has all the parameters, variables and objects needed to populate Level 2.
 ...
 * However, Coins now have less of a chance of spawning requiring the player to reach higher platforms to get points.
 * Gems are again spawned in on separate special platforms that give the player 3 points when collected.
 * It also loads more spikes than level 1 that can damage the player when collided with.
...
public class Level2 extends GameLevel {
    ...
    public void populate(Game game) {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            spikes.setPosition(new Vec2(-37 + (i * 17), -11));
